...
Update tblEmployee1 
Set ManagerId = 1006 
Where EmpId > 1100 AND EmpId < 1147
SELECT
    employee.EmpId,
        employee.EmpName,
        employee.ManagerId,
...
SELECT EmpName, EmpAddress FROM tblEmployee1 WHERE EmpAddress IN ('Bangalore','Mysore','Tumkur')
